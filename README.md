...
| [github_team_members.parent](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/team_members) | resource |
...
| <a name="input_team_children"></a> [team_children](#input_team_children) | Map of child teams to create | <pre>map(object({<br>    description     = string<br>    maintainers     = optional(set(string), [])<br>    members         = optional(set(string), [])<br>    parent_team_key = string<br>  }))</pre> | n/a | yes |
| <a name="input_team_parents"></a> [team_parents](#input_team_parents) | Map of parent teams to create | <pre>map(object({<br>    create_default_maintainer_team = optional(bool, false)<br>    description                    = string<br>    maintainers                    = optional(set(string), [])<br>    members                        = optional(set(string), [])<br>    privacy                        = optional(string, "closed")<br>  }))</pre> | n/a | yes |
